...
class AnimalType {
    public static void main(String args[]) {
        ...
        Animal cat = new Animal("Cat", 4, 4, "mamel");
        ...
        Animal cow = new Animal("Cow", 10, 4, "mamel");
        cow.incrementAge(10);
        ...
        Animal elephant = new Animal("Elephant", 11, 4, "mamel");
        cow.incrementAge(10);
        ...
        Animal Human = new Animal("Human", 18, 2, "mamel");
        cow.incrementAge(10);
